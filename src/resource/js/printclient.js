(function(w){
	...
	if(typeof w.massive=='undefined') w.massive = {}
	if(!w.massive.munit) w.massive.munit = {}
	if(!w.massive.munit.js) w.massive.munit.js = {}
	...
	*/
	...
	function createTestClass(testClass)
	{
		...
		var icon 		 = document.getElementById(currentClassId + "_icon");
	...
	*/
	...
	w.addToQueue 			= addToQueue;
	w.emptyQueue 			= emptyQueue;
	
	w.toggleVisibility 		= toggleVisibility;
	
	/*w.setResult 			= setResult;
	w.setResultBackground 	= setResultBackground;
	w.debug 				= debug;
	w.initialize 			= initialize;
	w.munitPrintLine 		= munitPrintLine;
	w.munitPrint 			= munitPrint;
	w.munitTrace 			= munitTrace;
	w.createTestClass 		= createTestClass;
	w.updateTestSummary 	= updateTestSummary;
	w.addTestTrace 			= addTestTrace;
	w.addTestPass 			= addTestPass;
	w.addTestFail 			= addTestFail;
	w.addTestError 			= addTestError;
	w.addTestIgnore 		= addTestIgnore;
	w.addTestCoverageClass 		= addTestCoverageClass;
	w.addTestCoverageItem 		= addTestCoverageItem;
	w.setTestClassResult 		= setTestClassResult;
	w.createCoverageReport 		= createCoverageReport;
	w.addMissingCoverageClass 	= addMissingCoverageClass;
	w.addCoverageReportSection 	= addCoverageReportSection;
	w.addCoverageSummary 		= addCoverageSummary;
		
	w.printSummary 			= printSummary;
	w.createTestDiv 		= createTestDiv;
	w.createSectionDiv 		= createSectionDiv;
	w.createDiv 			= createDiv;
	w.createLineBreak 		= createLineBreak;
	w.createTestClass 		= createTestClass;
	w.convertStringToId 	= convertStringToId;
	w.removeToggle 			= removeToggle;*/
